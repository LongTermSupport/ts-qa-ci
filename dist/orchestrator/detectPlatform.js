...
function readConsumerPackageJson(pkgPath) {
  ...
  try {
    ...
    console.warn(
      `ts-qa: could not parse ${pkgPath} as JSON (${error.message}); assuming generic platform`,
    );
    return undefined;
  }
}
