...
const rule = {
    meta: {
        ...
        messages: {
            classNameDeclared: '`className` may not be declared as a public prop. Remove it from this interface/type and express the desired presentation as a variant/size/tone/density prop on the component.',
        },
    },
    create(context) {
